...
import { idlFactory } from './favourse_frontend.did.js';
export { idlFactory } from './favourse_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FAVOURSE_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./favourse_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the favourse_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./favourse_frontend.did.js")._SERVICE>}
 */
export const favourse_frontend = createActor(canisterId);
